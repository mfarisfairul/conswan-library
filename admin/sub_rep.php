				...
				<h2><i class="fa fa-book"></i> List of Books</h2>
                        <div class="clearfix"></div>
							<ul class="nav nav-pills">
								...
								<li role="presentation" class="active"><a href="sub_rep.php">Replacement Books</a></li>
							</ul>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<tr>
								...
								<td>
									...
									<div class="modal fade" style="width: 80px;" id="delete<?php  echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
