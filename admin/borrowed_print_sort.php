...
<head>
		<title>Conswan Library | Borrowed Book Monitoring</title>
...
include ('include/dbcon.php');
								$borrow_query = mysqli_query($con,"SELECT * FROM borrow_book
									...
									where (borrow_book.date_borrowed BETWEEN '".$_SESSION['datefrom']." 00:00:01' and '".$_SESSION['dateto']." 23:59:59') and borrowed_status = 'The book has been borrowed'
...
?>
							<tr>
								...
								<td style="text-align:center;" style="text-transform: capitalize"><?php echo $borrow_row['book_level']; ?></td>
								<td style="text-align:center;"><?php echo date("M d, Y h:i:s A",strtotime($borrow_row['date_borrowed'])); ?></td>
								<td style="text-align:center;"><?php echo date("M d, Y h:i:s A",strtotime($borrow_row['due_date'])); ?></td>
								<td style="text-align:center;"><?php echo ($borrow_row['date_returned'] == "0000-00-00 00:00:00") ? "Delayed" : date("M d, Y h:i:s A",strtotime($borrow_row['date_returned'])); ?></td>
								<?php
