...
<body>
	<div class = "container">
		<div id = "header">
		<br/>
				<img src = "images/logo_convent.png" style = " margin-top:-17px; float:left; margin-left:115px; margin-bottom:-6px; width:80px; height:80px;">
				<img src = "images/ppd.png" style = " margin-top:-17px; float:right; margin-right:115px; width:80; height:80px;" >
				<center><h5 style = "font-style:Calibri; margin-top:-14px;"></h5> &nbsp; &nbsp; Conswan Library Management System</center>
				<center><h5 style = "font-style:Calibri; margin-top:-14px;"></h5> SMK CONVENT SITIAWAN, PERAK</center><br/>
				
<button type="submit" id="print" onclick="printPage()">Print</button>
			<p style = "margin-left:30px; margin-top:50px; font-size:14pt; font-weight:bold;">Returned Books Information&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
        <div align="right">
...
include ('include/dbcon.php');
							...
							where return_book.date_returned BETWEEN '".$_SESSION['datefrom']." 00:00:01' and '".$_SESSION['dateto']." 23:59:59' order by return_book.return_book_id DESC") or die (mysqli_error());
...
?>
						<table class="table table-striped">
                                <div class="pull-left">
                                    <div class="span"><div class="alert alert-info"><i class="icon-credit-card icon-large"></i>&nbsp;<strong>Date: From&nbsp;</strong><?php echo date("d/M/Y",strtotime($_SESSION['datefrom'])); ?> &nbsp;<strong>To&nbsp;</strong><?php echo date("d/M/Y",strtotime($_SESSION['dateto'])); ?></div></div>
                                </div>
								<br />
                                <div class="pull-left">
                                    <div class="span"><div class="alert alert-info"><i class="icon-credit-card icon-large"></i>&nbsp;Total Amount of Fine:&nbsp;<strong><?php echo "RM ".$count_penalty_row['sum(book_penalty)'].".00"; ?></strong></div></div>
                                </div>
								<br />
						  <thead>
								<tr>
...
?>
							<tr>
								...
								<?php
								 if ($return_row['book_penalty'] != 'No fine are imposed'){
									 echo "<td class='alert alert-warning' style='width:100px; text-align:center;'>RM".$return_row['book_penalty'].".00</td>";
								 }else {
							...
							if ($return_count <= 0){
								echo '
									<table style="float:right;">
										<tr>
											<td style="padding:10px;" class="alert alert-danger"><strong>Info!</strong> No Books returned at this Date</td>
										</tr>
									</table>
								';
							} 							
