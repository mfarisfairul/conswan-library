                        <div class="col-md-6 col-sm-6 col-xs-12" style="margin-left:276px; float:left;">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Allowable<small>by day</small></h2>
...
<?php //	include ('add_modal_example_3.php'); ?>
                                <div class="x_content">
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th>Number of days that can be borrowed</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
							...
							?>
                                            <tr>
                                                ...
                                                <td>
													<a class="btn btn-warning" for="ViewAdmin" href="#days_edit<?php echo $allowed_days_id; ?>" data-toggle="modal" data-target="#days_edit<?php echo $allowed_days_id;?>">
										...
										<div class="modal-body">
												...
												<form method="post" enctype="multipart/form-data" class="form-horizontal">
													<div class="form-group" style="margin-left:170px;">
														<label class="control-label col-md-4" for="first-name">Enter Total Of Days <span class="required"></span>
														</label>
														<div class="col-md-3">
															<input type="number" min="0" max="7" step="1" name="no_of_days" value="<?php echo $row44['no_of_days']; ?>" id="first-name2" class="form-control">
														</div>
													</div>
												...
												<?php
													...
													{
														echo "<script>alert('Edit Total Of Days Successfully!'); window.location='settings.php'</script>";
													}
