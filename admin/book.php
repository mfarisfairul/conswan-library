						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a class="btn btn-warning" style="width: 80px;" for="ViewAdmin" href="edit_book.php <?php echo '?book_id='.$id; ?>"><i class="fas fa-edit"></i> Edit
									</a>
									<a class="btn btn-danger" style="width: 80px;" for="DeleteAdmin" href="delete_book.php<?php echo $id;?>" data-toggle="modal" data-target="#delete<?php echo $id;?>">
											...
											<div class="modal-content">
												<div class="modal-header">
													<h4 class="modal-title" id="myModalLabel">
														<i class="glyphicon glyphicon-user"></i> Book</h4>
												</div>
												...
												<div class="modal-body">
													...
													<div class="modal-footer">
														...
														<a href="delete_book.php<?php echo '?book_id='.$id; ?>" style="margin-bottom:5px;" class="btn btn-primary">
