<?php include ('header.php'); ?>
        ...
        <div class="page-title">
            <div class="title_left">
                <h3>
					Returned Book Monitoring | <small><a href="home.php">Home</a></small>
                </h3>
            </div>
        </div>
...
-->
		...
		<!--- sort -->
						<form method="POST" action="returned_book_search.php" class="form-inline">
								...
								<button type="submit" name="search" class="btn btn-success btn-outline pull-right"><i class="fa fa-calendar-o"></i> Search By Returned Date</button>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">							
							...
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <div class="pull-right">
                                    <div class="span" ><div class="alert alert-info " style="color: white; background-color: #000F2A;"><i class="icon-credit-card icon-large"></i>&nbsp;Total Amount of Fine:&nbsp;<?php echo "RM".$count_penalty_row['sum(book_penalty)'].".00"; ?></div></div>
                                </div>
...
?>
							...
							if ($return_count <= 0){
								echo '
									<table style="float:right; padding-top:5px;">
										<tr>
