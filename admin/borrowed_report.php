<?php include ('header.php'); ?>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-file"></i> List of Borrowed Report</h2>
					...
					$count2 = mysqli_fetch_array(mysqli_query($con,"SELECT COUNT(*) as total FROM `report` WHERE `transaction_detail` = 'Returned Book'")) or die(mysqli_error());
					?>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							where transaction_detail = 'Borrowed Book'
