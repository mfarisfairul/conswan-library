...
<!--                            <li><a class="close-link"><i class="fa fa-close"></i></a></li>-->
					...
					?>
							<a href="borrowed.php"><button class="btn btn-primary"><i class="fa fa-reply"></i> Back <?php // echo $count_penalty['total']; ?></button></a>
    ...
    ?>
    	...
    	$dateto = $_POST['dateto'];
							...
							<tr>
								...
								<td style="text-transform: capitalize"><a href="borrow_book.php?student_num=<?php echo $borrow_row['student_num']; ?>"><?php echo $borrow_row['firstname']." ".$borrow_row['lastname']; ?></a></td>
