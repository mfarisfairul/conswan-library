<?php include ('header.php'); ?>
        ...
        <div class="page-title">
            <div class="title_left">
                <h3>
					<small><a href="home.php">Home</a> / <a href="user.php">Members</a> / </small> View Member Information
                </h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-info"></i> View Member Information</h2>
...
<?php
		...
		?>
						...
						<!--	<td>
								...
								<td><?php echo date("d M, Y  h:m:s a", strtotime($row['user_added'])); ?></td>
							</tr>
							<?php } ?>
							</tbody>
							</table>
