...
$sort=$_POST['sort'];
 ?>
							...
							<tr>
								...
								<td><?php echo ($borrow_row['date_returned'] == "0000-00-00 00:00:00") ? "Delayed" : date("M d, Y h:i:s a",strtotime($borrow_row['date_returned'])); ?></td>
								<?php
							...
							if ($borrow_count <= 0){
								echo '
									<table style="float:right;">
										<tr>
											<td style="padding:10px;" class="alert alert-danger"><strong>Info!</strong> No Books borrowed at this date</td>
										</tr>
									</table>
								';
							} 			
